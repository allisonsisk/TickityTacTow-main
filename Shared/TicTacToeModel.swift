...
class TicTacToeModel : ObservableObject {
    ...
    //the seperate squares possible wins for the code to check for
    ...
    //adding points to each of the sides
    ...
    private func checkIndexes(_ indexes : [Int]) -> SquareStatus? {
        ...
        //checking if someone won to reset the board
        if homeCounter == 3 {
            return .home
