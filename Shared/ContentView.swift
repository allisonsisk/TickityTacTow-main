    ...
    var body: some View {
        VStack {
            ...
            ForEach(0 ..<
                    ...
                    //button squares for game
                    
                    ticTacToeModel.squares.count / 3, content: {
                row in
                HStack {
                    ForEach(0 ..< 3, content: {
                        column in
            ...
            Alert(title: Text("Game Over"),
                  message:
                    //explanations for who wins and the resets
                  Text(self.ticTacToeModel.gameOver.0 != .empty ? self.ticTacToeModel.gameOver.0 == .home ? "You Win!": "AI Wins!" : "Nobody Wins" ) , dismissButton: Alert.Button.destructive(Text("Ok"), action: {
